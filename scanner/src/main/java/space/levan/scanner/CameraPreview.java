...
import space.levan.scanner.camera.CameraInstance;
import space.levan.scanner.camera.CameraParametersCallback;
import space.levan.scanner.camera.CameraSettings;
import space.levan.scanner.camera.CameraSurface;
import space.levan.scanner.camera.CenterCropStrategy;
import space.levan.scanner.camera.DisplayConfiguration;
import space.levan.scanner.camera.FitCenterStrategy;
import space.levan.scanner.camera.FitXYStrategy;
import space.levan.scanner.camera.PreviewScalingStrategy;
