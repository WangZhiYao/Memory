...
import space.levan.scanner.CaptureActivity;
...
public class IntentIntegrator {
    ...
    public static final Collection<String> PRODUCT_CODE_TYPES = list(UPC_A, UPC_E, EAN_13);
    public static final Collection<String> ONE_D_CODE_TYPES = list(UPC_A, UPC_E, EAN_13);
