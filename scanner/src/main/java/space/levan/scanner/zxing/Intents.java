...
public class Intents {
    ...
    public static final class Scan {
         ...
         * {@link space.levan.scanner.zxing.BarcodeFormat}s, e.g. {@link space.levan.scanner.zxing.BarcodeFormat#EAN_13}.
        ...
        /**
         * @see space.levan.scanner.zxing.DecodeHintType#CHARACTER_SET
         */
         ...
         * See {@link space.levan.scanner.zxing.BarcodeFormat} for possible values.
         */
         ...
         * to {@link space.levan.scanner.zxing.BarcodeFormat#UPC_A} and {@link space.levan.scanner.zxing.BarcodeFormat#EAN_13}
         * formats.
         */
        ...
        /**
         * Key for the value of {@link space.levan.scanner.zxing.ResultMetadataType#ORIENTATION}, if available.
         * Call {@link android.content.Intent#getIntArrayExtra(String)} with {@link #RESULT_ORIENTATION}.
         */
        public static final String RESULT_ORIENTATION = "SCAN_RESULT_ORIENTATION";

        /**
         * Key for the value of {@link space.levan.scanner.zxing.ResultMetadataType#ERROR_CORRECTION_LEVEL}, if available.
         * Call {@link android.content.Intent#getStringExtra(String)} with {@link #RESULT_ERROR_CORRECTION_LEVEL}.
         */
        public static final String RESULT_ERROR_CORRECTION_LEVEL = "SCAN_RESULT_ERROR_CORRECTION_LEVEL";

        /**
         * Prefix for keys that map to the values of {@link space.levan.scanner.zxing.ResultMetadataType#BYTE_SEGMENTS},
         ...
         * {@link space.levan.scanner.zxing.integration.android.IntentIntegrator#setBarcodeImageEnabled(boolean)}
         * is called with true.
         */
