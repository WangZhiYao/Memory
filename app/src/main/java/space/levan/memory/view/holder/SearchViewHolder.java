package space.levan.memory.view.holder;
...
import space.levan.memory.utils.common.AnimationUtils;
...
public class SearchViewHolder implements View.OnClickListener {
    ...
    public SearchViewHolder(Activity context, OnSearchHandlerListener listener)
    {
        ...
        mListener = listener;
        this.mContentView = LayoutInflater.from(context).inflate(R.layout.layout_search, null);
        initView();
        initEvent();
    }
